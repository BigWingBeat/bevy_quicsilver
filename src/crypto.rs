...
pub trait ServerConfigExt: Sized {
    ...
    /// Create a server config from a self-signed certificate generated by `rcgen`.
    #[cfg(any(feature = "rcgen_cert", test))]
    fn with_rcgen_cert(cert: rcgen::CertifiedKey) -> Result<Self, rustls::Error>;
}
